    ...
    const handleLogin = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // Authentication successful, use navigate function to redirect
                navigate('/voting');
            } else {
                        ...
                        <form action="">
                            ...
                            <div style={{ position: 'relative', margin: '0 auto', width: '310px', borderBottom: '2px solid black' }} className="inputbox">
                                ...
                                <input
                                    ...
                                    style={{ width: '100%', height: '50px', background: 'transparent', border: 'none', outline: 'none', fontSize: '1em', padding: '0 35px 0 5px', color: '#000000' }}
                                />
                            ...
                            <button onClick={handleLogin}
                                style={{ width: '50%', height: '40px', borderRadius: '40px', background: 'transparent', border: '2px solid black', outline: 'none', cursor: 'pointer', fontSize: '1em', fontWeight: '600', marginLeft: '6em' }}>Log in</button>
